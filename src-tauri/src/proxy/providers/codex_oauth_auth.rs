...
const TEST_DEVICE_AUTH_USERCODE_URL_ENV: &str = "CC_SWITCH_TEST_CODEX_DEVICE_AUTH_USERCODE_URL";
...
const TEST_DEVICE_VERIFICATION_URL_ENV: &str = "CC_SWITCH_TEST_CODEX_DEVICE_VERIFICATION_URL";
