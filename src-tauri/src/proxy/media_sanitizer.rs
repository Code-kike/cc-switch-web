        ...
        let mut body = json!({
            "input": [
                ...
                },
                {
                    ...
                    "call_id": "call_search",
                    "output": {"image_url": {"url": "https://example.com/search-thumbnail.png"}}
                }
            ]
        });
            ...
            "messages": [
                {
                    ...
                    "content": [
                        ...
                        {"type": "image_url", "image_url": {"url": "data:image/png;base64,USER_SENTINEL"}}
                    ]
                },
                {
                    "role": "tool",
                    "tool_call_id": "call_1",
                    "content": [{"type": "image_url", "image_url": {"url": "https://example.com/tool.png"}}]
                }
            ]
        });
