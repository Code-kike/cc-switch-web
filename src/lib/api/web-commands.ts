...
const cmds = defineCommands({
  add_custom_endpoint: {
    method: "POST",
    path: "/api/system/add_custom_endpoint",
  },
  ...
  apply_claude_onboarding_skip: {
    method: "POST",
    path: "/api/system/apply_claude_onboarding_skip",
  },
  ...
  auth_poll_for_account: {
    method: "POST",
    path: "/api/auth/auth-poll-for-account",
  },
  auth_remove_account: {
    method: "POST",
    path: "/api/auth/auth-remove-account",
  },
  auth_set_default_account: {
    method: "POST",
    path: "/api/auth/auth-set-default-account",
  },
  ...
  check_provider_limits: {
    method: "GET",
    path: "/api/providers/check-provider-limits",
  },
  check_skill_updates: {
    method: "GET",
    path: "/api/skills/check-skill-updates",
  },
  ...
  copilot_get_auth_status: {
    method: "POST",
    path: "/api/auth/copilot-get-auth-status",
    unsupported: true as const,
  },
  copilot_get_models: {
    method: "POST",
    path: "/api/copilot/copilot-get-models",
    unsupported: true as const,
  },
  copilot_get_models_for_account: {
    method: "POST",
    path: "/api/copilot/copilot-get-models-for-account",
    unsupported: true as const,
  },
  copilot_get_token: {
    method: "POST",
    path: "/api/copilot/copilot-get-token",
    unsupported: true as const,
  },
  copilot_get_token_for_account: {
    method: "POST",
    path: "/api/copilot/copilot-get-token-for-account",
    unsupported: true as const,
  },
  copilot_get_usage: {
    method: "POST",
    path: "/api/copilot/copilot-get-usage",
    unsupported: true as const,
  },
  copilot_get_usage_for_account: {
    method: "POST",
    path: "/api/copilot/copilot-get-usage-for-account",
    unsupported: true as const,
  },
  copilot_is_authenticated: {
    method: "POST",
    path: "/api/auth/copilot-is-authenticated",
    unsupported: true as const,
  },
  copilot_list_accounts: {
    method: "POST",
    path: "/api/copilot/copilot-list-accounts",
    unsupported: true as const,
  },
  copilot_logout: {
    method: "POST",
    path: "/api/copilot/copilot-logout",
    unsupported: true as const,
  },
  copilot_poll_for_account: {
    method: "POST",
    path: "/api/copilot/copilot-poll-for-account",
    unsupported: true as const,
  },
  copilot_poll_for_auth: {
    method: "POST",
    path: "/api/auth/copilot-poll-for-auth",
    unsupported: true as const,
  },
  copilot_remove_account: {
    method: "POST",
    path: "/api/copilot/copilot-remove-account",
    unsupported: true as const,
  },
  copilot_set_default_account: {
    method: "POST",
    path: "/api/copilot/copilot-set-default-account",
    unsupported: true as const,
  },
  copilot_start_device_flow: {
    method: "POST",
    path: "/api/copilot/copilot-start-device-flow",
    unsupported: true as const,
  },
  copy_text_to_clipboard: {
    method: "POST",
    path: "/api/system/copy_text_to_clipboard",
    unsupported: true as const,
  },
  ...
  delete_skill_backup: {
    method: "DELETE",
    path: "/api/backups/delete-skill-backup",
  },
  delete_universal_provider: {
    method: "DELETE",
    path: "/api/providers/delete-universal-provider",
  },
  disable_current_omo: { method: "POST", path: "/api/omo/disable-current-omo" },
  disable_current_omo_slim: {
    method: "POST",
    path: "/api/omo/disable-current-omo-slim",
  },
  ...
  exit_lightweight_mode: {
    method: "POST",
    path: "/api/system/exit-lightweight-mode",
  },
  ...
  get_app_config_path: {
    method: "GET",
    path: "/api/config/get-app-config-path",
  },
  get_auto_failover_enabled: {
    method: "GET",
    path: "/api/failover/get-auto-failover-enabled",
  },
  get_auto_launch_status: {
    method: "POST",
    path: "/api/system/get_auto_launch_status",
    unsupported: true as const,
  },
  ...
  get_claude_code_config_path: {
    method: "GET",
    path: "/api/config/get-claude-code-config-path",
  },
  get_claude_common_config_snippet: {
    method: "GET",
    path: "/api/config/get-claude-common-config-snippet",
  },
  get_claude_config_status: {
    method: "GET",
    path: "/api/config/get-claude-config-status",
  },
  ...
  get_claude_plugin_status: {
    method: "GET",
    path: "/api/vscode/get-claude-plugin-status",
    unsupported: true as const,
  },
  get_codex_oauth_quota: {
    method: "GET",
    path: "/api/auth/get-codex-oauth-quota",
  },
  ...
  get_common_config_snippet: {
    method: "GET",
    path: "/api/config/get-common-config-snippet",
  },
  ...
  get_copilot_optimizer_config: {
    method: "GET",
    path: "/api/config/get-copilot-optimizer-config",
    unsupported: true as const,
  },
  get_current_omo_provider_id: {
    method: "GET",
    path: "/api/omo/get-current-omo-provider-id",
  },
  get_current_omo_slim_provider_id: {
    method: "GET",
    path: "/api/omo/get-current-omo-slim-provider-id",
  },
  get_current_prompt_file_content: {
    method: "GET",
    path: "/api/prompts/get-current-prompt-file-content",
  },
  get_current_provider: {
    method: "GET",
    path: "/api/providers/get-current-provider",
  },
  get_custom_endpoints: {
    method: "POST",
    path: "/api/system/get_custom_endpoints",
  },
  get_default_cost_multiplier: {
    method: "POST",
    path: "/api/system/get_default_cost_multiplier",
  },
  get_failover_queue: {
    method: "GET",
    path: "/api/failover/get-failover-queue",
  },
  get_global_proxy_config: {
    method: "GET",
    path: "/api/config/get-global-proxy-config",
  },
  get_global_proxy_url: {
    method: "GET",
    path: "/api/global-proxy/get-global-proxy-url",
  },
  get_hermes_live_provider: {
    method: "GET",
    path: "/api/hermes/get-hermes-live-provider",
  },
  get_hermes_live_provider_ids: {
    method: "GET",
    path: "/api/hermes/get-hermes-live-provider-ids",
  },
  ...
  get_hermes_model_config: {
    method: "GET",
    path: "/api/config/get-hermes-model-config",
  },
  ...
  get_openclaw_default_model: {
    method: "GET",
    path: "/api/openclaw/get-openclaw-default-model",
  },
  get_openclaw_env: { method: "GET", path: "/api/env/get-openclaw-env" },
  get_openclaw_live_provider: {
    method: "GET",
    path: "/api/openclaw/get-openclaw-live-provider",
  },
  get_openclaw_live_provider_ids: {
    method: "GET",
    path: "/api/openclaw/get-openclaw-live-provider-ids",
  },
  get_openclaw_model_catalog: {
    method: "GET",
    path: "/api/openclaw/get-openclaw-model-catalog",
  },
  get_openclaw_tools: {
    method: "GET",
  ...
  get_opencode_live_provider_ids: {
    method: "GET",
    path: "/api/providers/get-opencode-live-provider-ids",
  },
  get_optimizer_config: {
    method: "GET",
    path: "/api/config/get-optimizer-config",
  },
  ...
  get_provider_health: {
    method: "GET",
    path: "/api/providers/get-provider-health",
  },
  get_provider_stats: {
    method: "GET",
    path: "/api/providers/get-provider-stats",
  },
  ...
  get_proxy_config_for_app: {
    method: "GET",
    path: "/api/config/get-proxy-config-for-app",
  },
  ...
  get_rectifier_config: {
    method: "GET",
    path: "/api/config/get-rectifier-config",
  },
  get_request_detail: {
    method: "POST",
  ...
  get_skills_migration_result: {
    method: "GET",
    path: "/api/skills/get-skills-migration-result",
  },
  ...
  get_subscription_quota: {
    method: "GET",
    path: "/api/subscription/get-subscription-quota",
  },
  get_tool_versions: { method: "POST", path: "/api/system/get_tool_versions" },
  get_universal_provider: {
    method: "GET",
    path: "/api/providers/get-universal-provider",
  },
  get_universal_providers: {
    method: "GET",
    path: "/api/providers/get-universal-providers",
  },
  get_upstream_proxy_status: {
    method: "GET",
    path: "/api/proxy/get-upstream-proxy-status",
  },
  ...
  get_usage_summary_by_app: {
    method: "GET",
    path: "/api/usage/get-usage-summary-by-app",
  },
  get_usage_trends: { method: "GET", path: "/api/usage/get-usage-trends" },
  import_config_from_file: {
    method: "POST",
    path: "/api/config/import-config-from-file",
    webReplacement: true as const,
  },
  ...
  import_from_deeplink: {
    method: "POST",
    path: "/api/deeplink/import-from-deeplink",
  },
  ...
  import_prompt_from_file: {
    method: "POST",
    path: "/api/prompts/import-prompt-from-file",
    webReplacement: true as const,
  },
  import_skills_from_apps: {
    method: "POST",
    path: "/api/skills/import-skills-from-apps",
  },
  install_skill: { method: "POST", path: "/api/skills/install-skill" },
  install_skill_for_app: {
    method: "POST",
    path: "/api/skills/install-skill-for-app",
  },
  install_skill_unified: {
    method: "POST",
    path: "/api/skills/install-skill-unified",
  },
  install_skills_from_zip: {
    method: "POST",
    path: "/api/skills/install-skills-from-zip",
    webReplacement: true as const,
  },
  is_claude_plugin_applied: {
    method: "GET",
    path: "/api/vscode/is-claude-plugin-applied",
    unsupported: true as const,
  },
  is_lightweight_mode: {
    method: "GET",
    path: "/api/system/is-lightweight-mode",
  },
  is_live_takeover_active: {
    method: "POST",
    path: "/api/system/is_live_takeover_active",
  },
  ...
  launch_hermes_dashboard: {
    method: "POST",
    path: "/api/hermes/launch-hermes-dashboard",
  },
  ...
  migrate_skill_storage: {
    method: "POST",
    path: "/api/skills/migrate-skill-storage",
  },
  ...
  open_file_dialog: {
    method: "POST",
    path: "/api/system/open_file_dialog",
    webReplacement: true as const,
  },
  open_hermes_web_ui: {
    method: "POST",
    path: "/api/hermes/open-hermes-web-ui",
  },
  ...
  open_zip_file_dialog: {
    method: "POST",
    path: "/api/system/open_zip_file_dialog",
    webReplacement: true as const,
  },
  ...
  queryProviderUsage: {
    method: "POST",
    path: "/api/providers/queryproviderusage",
  },
  ...
  read_claude_plugin_config: {
    method: "GET",
    path: "/api/config/read-claude-plugin-config",
  },
  ...
  remove_provider_from_live_config: {
    method: "DELETE",
    path: "/api/config/remove-provider-from-live-config",
  },
  remove_skill_repo: {
    method: "DELETE",
  ...
  restore_env_backup: {
    method: "POST",
    path: "/api/backups/restore-env-backup",
  },
  ...
  scan_local_proxies: {
    method: "POST",
    path: "/api/system/scan_local_proxies",
  },
  ...
  scan_unmanaged_skills: {
    method: "GET",
    path: "/api/skills/scan-unmanaged-skills",
  },
  ...
  set_app_config_dir_override: {
    method: "PUT",
    path: "/api/config/set-app-config-dir-override",
  },
  ...
  set_auto_launch: {
    method: "POST",
    path: "/api/system/set_auto_launch",
    unsupported: true as const,
  },
  set_claude_common_config_snippet: {
    method: "PUT",
    path: "/api/config/set-claude-common-config-snippet",
  },
  set_common_config_snippet: {
    method: "PUT",
    path: "/api/config/set-common-config-snippet",
  },
  set_copilot_optimizer_config: {
    method: "PUT",
    path: "/api/config/set-copilot-optimizer-config",
    unsupported: true as const,
  },
  set_default_cost_multiplier: {
    method: "POST",
    path: "/api/system/set_default_cost_multiplier",
  },
  set_global_proxy_url: {
    method: "PUT",
    path: "/api/global-proxy/set-global-proxy-url",
  },
  ...
  set_openclaw_default_model: {
    method: "PUT",
    path: "/api/openclaw/set-openclaw-default-model",
  },
  set_openclaw_env: { method: "PUT", path: "/api/env/set-openclaw-env" },
  set_openclaw_model_catalog: {
    method: "PUT",
    path: "/api/openclaw/set-openclaw-model-catalog",
  },
  set_openclaw_tools: {
    method: "PUT",
  ...
  set_optimizer_config: {
    method: "PUT",
    path: "/api/config/set-optimizer-config",
  },
  set_pricing_model_source: {
    method: "POST",
    path: "/api/system/set_pricing_model_source",
  },
  set_proxy_takeover_for_app: {
    method: "PUT",
    path: "/api/proxy/set-proxy-takeover-for-app",
  },
  set_rectifier_config: {
    method: "PUT",
    path: "/api/config/set-rectifier-config",
  },
  set_window_theme: {
    method: "POST",
    path: "/api/system/set_window_theme",
    unsupported: true as const,
  },
  start_proxy_server: { method: "POST", path: "/api/proxy/start-proxy-server" },
  stop_proxy_with_restore: {
    method: "POST",
    path: "/api/proxy/stop-proxy-with-restore",
  },
  stream_check_all_providers: {
    method: "POST",
    path: "/api/providers/stream-check-all-providers",
  },
  stream_check_provider: {
    method: "POST",
    path: "/api/providers/stream-check-provider",
  },
  switch_provider: { method: "POST", path: "/api/providers/switch-provider" },
  switch_proxy_provider: {
    method: "POST",
    path: "/api/providers/switch-proxy-provider",
  },
  sync_current_providers_live: {
    method: "POST",
    path: "/api/providers/sync-current-providers-live",
  },
  sync_session_usage: {
    method: "POST",
  ...
  sync_universal_provider: {
    method: "POST",
    path: "/api/providers/sync-universal-provider",
  },
  testUsageScript: { method: "POST", path: "/api/usage/testusagescript" },
  test_api_endpoints: {
    method: "POST",
    path: "/api/system/test_api_endpoints",
  },
  ...
  uninstall_skill_for_app: {
    method: "POST",
    path: "/api/skills/uninstall-skill-for-app",
  },
  ...
  update_global_proxy_config: {
    method: "PUT",
    path: "/api/config/update-global-proxy-config",
  },
  ...
  update_proxy_config: {
    method: "PUT",
    path: "/api/config/update-proxy-config",
  },
  ...
  update_tray_menu: {
    method: "POST",
    path: "/api/system/update_tray_menu",
    unsupported: true as const,
  },
  ...
  upsert_universal_provider: {
    method: "POST",
    path: "/api/providers/upsert-universal-provider",
  },
  ...
  webdav_sync_download: {
    method: "POST",
    path: "/api/webdav/webdav-sync-download",
  },
  webdav_sync_fetch_remote_info: {
    method: "POST",
    path: "/api/webdav/webdav-sync-fetch-remote-info",
  },
  webdav_sync_save_settings: {
    method: "POST",
    path: "/api/settings/webdav-sync-save-settings",
  },
  webdav_sync_upload: {
    method: "POST",
    path: "/api/webdav/webdav-sync-upload",
  },
  webdav_test_connection: {
    method: "POST",
    path: "/api/webdav/webdav-test-connection",
  },
