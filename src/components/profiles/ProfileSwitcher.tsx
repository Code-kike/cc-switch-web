...
/**
 * Project switcher for the current application scope.
 *
 * Project entities are shared, but Claude Code and Codex independently point
 * to and autosave their current project snapshots. Unsupported app tabs render
 * no switcher so they cannot imply profile coverage that the backend lacks.
 */
