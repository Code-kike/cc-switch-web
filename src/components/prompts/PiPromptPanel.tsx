...
/**
 * Which entity the header "+" button creates for the active tab.
 * `null` means the tab has no create action (its resources are fixed files).
 */
  ...
  (
    ...
    React.useImperativeHandle(
      ...
      () => ({
        ...
        openImport: async () => {
          // Importing seeds the global prompt library from Pi's AGENTS.md; the
          // other tabs manage fixed files and have nothing to import into.
      ...
      [activeTab, importFromFile, reload],
    );
