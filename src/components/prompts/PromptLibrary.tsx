...
/**
 * Prompt collection header + search + list.
 *
 * Currently consumed only by `PiPromptPanel`; the non-Pi `PromptPanel` path
 * keeps its own inline list on purpose (see task Q3 ruling) so porting Pi does
 * not change the prompt UI of the seven pre-existing apps.
 */
